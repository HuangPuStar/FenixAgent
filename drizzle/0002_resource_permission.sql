...
CREATE TYPE "public"."resource_permission_type" AS ENUM('provider', 'skill', 'mcp_server', 'agent_config');--> statement-breakpoint
CREATE TABLE "resource_permission" (
	...
	CONSTRAINT "idx_resource_permission_unique" UNIQUE NULLS NOT DISTINCT("organization_id","resource_type","resource_id","principal_type","principal_id","action")
);
