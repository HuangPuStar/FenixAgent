...
import { Activity, ArrowLeft, FileText, type LucideIcon, Network } from "lucide-react";
...
const NAV_ITEMS: { to: "/admin" | "/admin/logs" | "/admin/people"; labelKey: string; icon: LucideIcon }[] = [
