...
import { createSandboxClusterAdminService, SandboxClusterUnavailableError } from "@fenix/resource-sandbox/server";
...
describe("sandbox cluster admin service", () => {
  ...
  test("fails closed when cluster credentials are missing", async () => {
    initializeSandboxModuleConfig({ openSandboxClusterUrl: undefined, openSandboxClusterApiKey: undefined });
