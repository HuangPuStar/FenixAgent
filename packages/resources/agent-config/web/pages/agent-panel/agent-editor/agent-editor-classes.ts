...
export const WORKSPACE =
  ...
  "[@media(min-width:1120px)_and_(max-width:1399px)]:grid-cols-[168px_minmax(360px,1fr)_220px] " +
  "[@media(min-width:760px)_and_(max-width:1119px)]:grid-cols-[148px_minmax(280px,1fr)_190px] " +
...
export const CONFIG_MAP =
  ...
  "[@media(min-width:1120px)_and_(max-width:1399px)]:px-[7px] [@media(min-width:1120px)_and_(max-width:1399px)]:pt-2 [@media(min-width:1120px)_and_(max-width:1399px)]:pb-[7px] " +
  "[@media(min-width:760px)_and_(max-width:1119px)]:px-[6px] [@media(min-width:760px)_and_(max-width:1119px)]:pt-2 [@media(min-width:760px)_and_(max-width:1119px)]:pb-[7px] " +
...
export const MAP_TRIGGER =
  ...
  "[@media(min-width:1120px)_and_(max-width:1399px)]:!min-h-[44px] [@media(min-width:1120px)_and_(max-width:1399px)]:!grid-cols-[26px_minmax(0,1fr)_auto] " +
  "[@media(min-width:1120px)_and_(max-width:1399px)]:!gap-[7px] [@media(min-width:1120px)_and_(max-width:1399px)]:!px-[7px] [@media(min-width:1120px)_and_(max-width:1399px)]:!py-[4px] " +
  "[@media(min-width:760px)_and_(max-width:1119px)]:!min-h-[44px] [@media(min-width:760px)_and_(max-width:1119px)]:!grid-cols-[24px_minmax(0,1fr)] " +
  "[@media(min-width:760px)_and_(max-width:1119px)]:!gap-[7px] [@media(min-width:760px)_and_(max-width:1119px)]:!px-[6px] [@media(min-width:760px)_and_(max-width:1119px)]:!py-[4px] " +
...
export const MAP_ICON =
  ...
  "[@media(min-width:760px)_and_(max-width:1399px)]:size-[26px] " +
...
export const MAP_BADGE =
  ...
  "[@media(min-width:760px)_and_(max-width:1119px)]:hidden [@media(max-width:759px)]:hidden";
...
export const MAP_COPY =
  ...
  "[&>small]:[font-weight:400] [&>small]:leading-[1.35] [&>small]:text-[#8d99ab] [@media(min-width:760px)_and_(max-width:1119px)]:[&>small]:hidden";
/** 中栏内容区：白底 + 内边距按「宽度档 × 高度档」互斥条件（避免同属性多值看生成顺序）。 */
export const CONTENT =
  "overflow-x-hidden bg-[#fff] [padding:16px_20px_20px] " +
  "[@media(min-width:1120px)_and_(max-width:1399px)_and_(min-height:701px)]:[padding:14px_18px_16px] " +
  "[@media(min-width:760px)_and_(max-width:1119px)_and_(min-height:701px)]:[padding:14px_12px_16px] " +
  "[@media(min-width:1400px)_and_(max-height:700px)]:[padding:12px_20px_14px] " +
  "[@media(min-width:1120px)_and_(max-width:1399px)_and_(max-height:700px)]:[padding:12px_18px_14px] " +
  "[@media(min-width:760px)_and_(max-width:1119px)_and_(max-height:700px)]:[padding:12px_12px_14px] " +
...
export const SUMMARY_ASIDE =
  ...
  "[@media(min-width:1120px)_and_(max-width:1399px)]:[padding:12px_10px_10px] " +
  "[@media(min-width:760px)_and_(max-width:1119px)]:[padding:10px_8px_8px] " +
  "[@media(min-width:760px)_and_(max-width:1119px)]:block";
...
export const FOOTER =
  ...
  "[@media(min-width:760px)_and_(max-width:1399px)]:basis-[52px] [@media(min-width:760px)_and_(max-width:1399px)]:min-h-[52px] " +
...
export const FOOTER_ACTIONS =
  ...
  "[@media(min-width:760px)_and_(max-width:1399px)]:[&>[data-slot=button]]:!h-[30px]";
...
export const SECTION_INTRO =
  "mb-[26px] [@media(min-width:1120px)_and_(max-width:1399px)_and_(min-height:701px)]:mb-[20px] " +
  "[@media(min-width:760px)_and_(max-width:1119px)_and_(min-height:701px)]:mb-[20px] " +
  "[@media(min-width:760px)_and_(max-height:700px)]:mb-[12px]";
