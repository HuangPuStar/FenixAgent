 ...
 * 宿主 i18n 注册与生成的 registry）：i18n 已由宿主 `apps/web/src/i18n/index.ts:23` 经 `./web/i18n` 子路径
 * 消费（2026-09-20 落地）；浏览器侧还剩 3 处宿主直连——`vite.config.ts:131` / `:133-135` 的 `@/src/…`
 * alias（后者取 `AgentTasksPage`，importer 是 `routes/agent/_panel/tasks.tsx:5` 的懒加载）与
 * `ArtifactsPanel.tsx:15` 的深层相对路径取 `TasksPanel`；W3 起这三处改为本入口。
