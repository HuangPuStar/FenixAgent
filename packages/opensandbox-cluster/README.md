...
然后将文件安全地挂载到 Server 的 `/etc/frp/frpc.toml`，参考 [`../../docker/opensandbox-server-tunnel/README.md`](../../docker/opensandbox-server-tunnel/README.md) 启动或重启 Server，等待 FRP 连接恢复。
