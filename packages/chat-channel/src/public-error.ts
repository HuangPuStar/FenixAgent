...
export const PUBLIC_ERROR_MESSAGES: Readonly<Record<PublicErrorType, PublicErrorMessages>> = {
  ...
  "AGENT_RUNTIME.LLM_API_ERROR": { zh: "LLM API 请求失败。", en: "The LLM API request failed." },
  "AGENT_RUNTIME.LLM_API_CONFIGURATION_ERROR": {
    zh: "LLM API 认证或权限配置无效。",
    en: "The LLM API authentication or authorization configuration is invalid.",
  },
  "AGENT_RUNTIME.LLM_API_RATE_LIMITED": {
    zh: "LLM API 请求受到速率限制。",
    en: "The LLM API request was rate limited.",
  },
