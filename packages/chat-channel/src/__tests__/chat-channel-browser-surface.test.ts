...
describe("chat-channel 根入口浏览器可达面", () => {
  ...
  test("旧聊天根路径不存在", () => {
    const oldPaths = [
      ...
      "web/src/pages/agent-panel/chat-design-composer.css",
      "web/src/pages/agent-panel/chat-design-messages-tools.css",
      "web/src/pages/agent-panel/chat-design-responsive.css",
      "web/src/pages/agent-panel/chat-design-selection.css",
      "web/src/pages/agent-panel/chat-design-shell.css",
      "web/src/pages/agent-panel/chat-design-status.css",
      "web/src/pages/agent-panel/chat-design.css",
