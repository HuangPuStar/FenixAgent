...
/**
 * AI 元素分区：Message / Conversation / PromptInput / Reasoning / Tool / CodeBlock /
 * Shimmer / PermissionRequest / MessageAttachments / IframePreview。
    ...
    parts: [
      {
        ...
        text: [
          ...
          "| `ai-elements` | `Message`, `PromptInput`, `Tool` |",
          "",
...
export function AiSection() {
  ...
  return (
    <section className="demo-section">
      <h1 className="demo-section-title">{t("sections.ai")}</h1>
