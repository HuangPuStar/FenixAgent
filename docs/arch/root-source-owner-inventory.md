...
| `src/schemas/index.ts` | `apps/server/src/schemas/index.ts` | apps-server | packages/resources/skill/src/server/routes/web/config/skills.ts; src/routes/web/sidebar-config.ts | packages/resources/machine/src/__tests__/registry-routes.test.ts | RMD-07 |
