...
| `src/repositories/index.ts` | `apps/server/src/repositories/index.ts` | apps-server | apps/server/src/auth/token.ts; apps/server/src/test-utils/setup-mocks.ts; packages/agent-runtime/src/services/acp-idle-monitor.ts; packages/agent-runtime/src/services/orchestration-bootstrap.ts; packages/platform/access-control/src/resource-permission.ts; packages/resources/observer/src/server/services/observer/observer-service.ts | apps/server/src/__tests__/auth.test.ts | RMD-07 |
...
| `src/schemas/index.ts` | `apps/server/src/schemas/index.ts` | apps-server | packages/resources/skill/src/server/routes/web/config/skills.ts; src/routes/web/sidebar-config.ts | src/__tests__/registry-routes.test.ts | RMD-07 |
...
| `src/services/event-service.ts` | `packages/resources/machine/src/services/event-service.ts` | resource-machine | packages/agent-runtime/src/services/session.ts; packages/resources/channel/src/server/services/hermes-client.ts; src/routes/web/control.ts; src/services/transport.ts | packages/resources/channel/src/__tests__/round49-hermes-client.test.ts, src/__tests__/round21-isolated-service-coverage.test.ts | RMD-02 |
| `src/services/local-node-service.ts` | `packages/resources/machine/src/services/local-node-service.ts` | resource-machine | packages/agent-runtime/src/services/orchestration-bootstrap.ts; packages/agent-runtime/src/services/orchestration-instance.ts | src/__tests__/local-node-service.test.ts | RMD-02 |
