...
| 任务 | Owner | 文件数 |
| --- | --- | ---: |
| RMD-01 | agent-runtime | 74 |
| RMD-01 | chat-channel | 20 |
| RMD-02 | resource-machine | 30 |
| RMD-03 | resource-sandbox | 22 |
| RMD-04 | agent-config | 12 |
| RMD-04 | model-management | 20 |
| RMD-05 | agent-config | 2 |
| RMD-05 | resource-knowledge | 3 |
| RMD-06 | identity-admin | 7 |
| RMD-06 | platform-access-control | 5 |
...
| --- | --- | --- | --- | --- | --- |
| `src/__tests__/acp-idle-monitor.test.ts` | `packages/agent-runtime/src/__tests__/acp-idle-monitor.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/acp-idle-monitor.test.ts | RMD-01 |
| `src/__tests__/acp-machine-connection-lookup.test.ts` | `packages/agent-runtime/src/__tests__/acp-machine-connection-lookup.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/acp-machine-connection-lookup.test.ts | RMD-01 |
| `src/__tests__/acp-machine-register.test.ts` | `packages/agent-runtime/src/__tests__/acp-machine-register.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/acp-machine-register.test.ts | RMD-01 |
| `src/__tests__/acp-ws-auth.test.ts` | `packages/agent-runtime/src/__tests__/acp-ws-auth.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/acp-ws-auth.test.ts | RMD-01 |
| `src/__tests__/agent-chat-service-boundaries.test.ts` | `packages/agent-runtime/src/__tests__/agent-chat-service-boundaries.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/agent-chat-service-boundaries.test.ts | RMD-01 |
| `src/__tests__/agent-chat-service-concurrency.test.ts` | `packages/agent-runtime/src/__tests__/agent-chat-service-concurrency.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/agent-chat-service-concurrency.test.ts | RMD-01 |
| `src/__tests__/agent-concurrency-toctou.test.ts` | `packages/agent-runtime/src/__tests__/agent-concurrency-toctou.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/agent-concurrency-toctou.test.ts | RMD-01 |
| `src/__tests__/agent-concurrency.test.ts` | `packages/agent-runtime/src/__tests__/agent-concurrency.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/agent-concurrency.test.ts | RMD-01 |
| `src/__tests__/agent-node-bridge.test.ts` | `packages/agent-runtime/src/__tests__/agent-node-bridge.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/agent-node-bridge.test.ts | RMD-01 |
| `src/__tests__/agent-node-socket-send.test.ts` | `packages/agent-runtime/src/__tests__/agent-node-socket-send.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/agent-node-socket-send.test.ts | RMD-01 |
...
| `src/__tests__/api-agent-schema.test.ts` | `packages/resources/agent-config/src/__tests__/api-agent-schema.test.ts` | agent-config | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/agent-config 公开入口 | src/__tests__/api-agent-schema.test.ts | RMD-04 |
| `src/__tests__/api-instance-routes.test.ts` | `packages/agent-runtime/src/__tests__/api-instance-routes.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/api-instance-routes.test.ts | RMD-01 |
| `src/__tests__/api-instance-service.test.ts` | `packages/agent-runtime/src/__tests__/api-instance-service.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/api-instance-service.test.ts | RMD-01 |
| `src/__tests__/api-sandbox-schema.test.ts` | `packages/resources/sandbox/src/__tests__/api-sandbox-schema.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/api-sandbox-schema.test.ts | RMD-03 |
| `src/__tests__/api-sandbox-server.test.ts` | `packages/resources/sandbox/src/__tests__/api-sandbox-server.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/api-sandbox-server.test.ts | RMD-03 |
...
| `src/__tests__/chat-channel-action-translator.test.ts` | `packages/chat-channel/src/__tests__/chat-channel-action-translator.test.ts` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | src/__tests__/chat-channel-action-translator.test.ts | RMD-01 |
| `src/__tests__/chat-channel-browser-surface.test.ts` | `packages/chat-channel/src/__tests__/chat-channel-browser-surface.test.ts` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | src/__tests__/chat-channel-browser-surface.test.ts | RMD-01 |
...
| `src/__tests__/environment-max-sessions-migration.test.ts` | `packages/agent-runtime/src/__tests__/environment-max-sessions-migration.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/environment-max-sessions-migration.test.ts | RMD-01 |
| `src/__tests__/environment-orchestration.test.ts` | `packages/agent-runtime/src/__tests__/environment-orchestration.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/environment-orchestration.test.ts | RMD-01 |
| `src/__tests__/environment-role.test.ts` | `packages/agent-runtime/src/__tests__/environment-role.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/environment-role.test.ts | RMD-01 |
| `src/__tests__/environment-schema.test.ts` | `packages/agent-runtime/src/__tests__/environment-schema.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/environment-schema.test.ts | RMD-01 |
| `src/__tests__/environment-startup-lock.test.ts` | `packages/agent-runtime/src/__tests__/environment-startup-lock.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/environment-startup-lock.test.ts | RMD-01 |
...
| `src/__tests__/event-bus.test.ts` | `packages/agent-runtime/src/__tests__/event-bus.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/event-bus.test.ts | RMD-01 |
...
| `src/__tests__/external-relay.test.ts` | `packages/agent-runtime/src/__tests__/external-relay.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/external-relay.test.ts | RMD-01 |
| `src/__tests__/extract-acp-event.test.ts` | `packages/agent-runtime/src/__tests__/extract-acp-event.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/extract-acp-event.test.ts | RMD-01 |
| `src/__tests__/fs-symlink-escape.test.ts` | `packages/resources/machine/src/__tests__/fs-symlink-escape.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/fs-symlink-escape.test.ts | RMD-02 |
| `src/__tests__/fs-upload-escape.test.ts` | `packages/resources/machine/src/__tests__/fs-upload-escape.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/fs-upload-escape.test.ts | RMD-02 |
| `src/__tests__/instance-concurrency.test.ts` | `packages/agent-runtime/src/__tests__/instance-concurrency.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/instance-concurrency.test.ts | RMD-01 |
| `src/__tests__/instance-machine-fallback.test.ts` | `packages/agent-runtime/src/__tests__/instance-machine-fallback.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/instance-machine-fallback.test.ts | RMD-01 |
| `src/__tests__/instances-delete-idempotent.test.ts` | `packages/agent-runtime/src/__tests__/instances-delete-idempotent.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/instances-delete-idempotent.test.ts | RMD-01 |
...
| `src/__tests__/launch-spec-agent-sharing-access.test.ts` | `packages/agent-runtime/src/__tests__/launch-spec-agent-sharing-access.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/launch-spec-agent-sharing-access.test.ts | RMD-01 |
| `src/__tests__/launch-spec-builder-errors.test.ts` | `packages/agent-runtime/src/__tests__/launch-spec-builder-errors.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/launch-spec-builder-errors.test.ts | RMD-01 |
| `src/__tests__/launch-spec-builder-hindsight.test.ts` | `packages/agent-runtime/src/__tests__/launch-spec-builder-hindsight.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/launch-spec-builder-hindsight.test.ts | RMD-01 |
| `src/__tests__/launch-spec-langfuse-env.test.ts` | `packages/agent-runtime/src/__tests__/launch-spec-langfuse-env.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/launch-spec-langfuse-env.test.ts | RMD-01 |
| `src/__tests__/launch-spec-mcp-resource-access.test.ts` | `packages/agent-runtime/src/__tests__/launch-spec-mcp-resource-access.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/launch-spec-mcp-resource-access.test.ts | RMD-01 |
| `src/__tests__/launch-spec-model-gateway.test.ts` | `packages/agent-runtime/src/__tests__/launch-spec-model-gateway.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/launch-spec-model-gateway.test.ts | RMD-01 |
| `src/__tests__/launch-spec-provider-model-access.test.ts` | `packages/agent-runtime/src/__tests__/launch-spec-provider-model-access.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/launch-spec-provider-model-access.test.ts | RMD-01 |
| `src/__tests__/local-instance-death-cleanup.test.ts` | `packages/agent-runtime/src/__tests__/local-instance-death-cleanup.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/local-instance-death-cleanup.test.ts | RMD-01 |
| `src/__tests__/local-node-service.test.ts` | `packages/resources/machine/src/__tests__/local-node-service.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/local-node-service.test.ts | RMD-02 |
| `src/__tests__/machine-cleanup-node-dispatch.test.ts` | `packages/agent-runtime/src/__tests__/machine-cleanup-node-dispatch.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/machine-cleanup-node-dispatch.test.ts | RMD-01 |
| `src/__tests__/machine-resource-surface.test.ts` | `packages/resources/machine/src/__tests__/machine-resource-surface.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/machine-resource-surface.test.ts | RMD-02 |
| `src/__tests__/machine-sandbox-projection.test.ts` | `packages/resources/machine/src/__tests__/machine-sandbox-projection.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/machine-sandbox-projection.test.ts | RMD-02 |
| `src/__tests__/meta-agent.test.ts` | `packages/resources/agent-config/src/__tests__/meta-agent.test.ts` | agent-config | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/agent-config 公开入口 | src/__tests__/meta-agent.test.ts | RMD-04 |
...
| `src/__tests__/model-gateway-admin-ui-route.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-admin-ui-route.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-admin-ui-route.test.ts | RMD-04 |
| `src/__tests__/model-gateway-budget-service.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-budget-service.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-budget-service.test.ts | RMD-04 |
| `src/__tests__/model-gateway-credential-service.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-credential-service.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-credential-service.test.ts | RMD-04 |
| `src/__tests__/model-gateway-credential.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-credential.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-credential.test.ts | RMD-04 |
| `src/__tests__/model-gateway-key-management-service.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-key-management-service.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-key-management-service.test.ts | RMD-04 |
| `src/__tests__/model-gateway-model-sync.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-model-sync.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-model-sync.test.ts | RMD-04 |
| `src/__tests__/model-gateway-provider-service.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-provider-service.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-provider-service.test.ts | RMD-04 |
| `src/__tests__/model-gateway-runtime-credential-resolver.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-runtime-credential-resolver.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-runtime-credential-resolver.test.ts | RMD-04 |
| `src/__tests__/model-gateway-schema.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-schema.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-schema.test.ts | RMD-04 |
| `src/__tests__/model-gateway-subject-service.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-subject-service.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-subject-service.test.ts | RMD-04 |
| `src/__tests__/model-gateway-usage-mapping-service.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-usage-mapping-service.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-usage-mapping-service.test.ts | RMD-04 |
| `src/__tests__/model-gateway-usage-service.test.ts` | `packages/resources/model-management/src/__tests__/model-gateway-usage-service.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | src/__tests__/model-gateway-usage-service.test.ts | RMD-04 |
| `src/__tests__/openai-chat-routes.test.ts` | `packages/agent-runtime/src/__tests__/openai-chat-routes.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/openai-chat-routes.test.ts | RMD-01 |
| `src/__tests__/openai-chat-service.test.ts` | `packages/agent-runtime/src/__tests__/openai-chat-service.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/openai-chat-service.test.ts | RMD-01 |
| `src/__tests__/openai-response-mapper.test.ts` | `packages/agent-runtime/src/__tests__/openai-response-mapper.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/openai-response-mapper.test.ts | RMD-01 |
| `src/__tests__/orchestration-bootstrap-resolver.test.ts` | `packages/agent-runtime/src/__tests__/orchestration-bootstrap-resolver.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/orchestration-bootstrap-resolver.test.ts | RMD-01 |
| `src/__tests__/orchestration-instance-cleanup-isolation.test.ts` | `packages/agent-runtime/src/__tests__/orchestration-instance-cleanup-isolation.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/orchestration-instance-cleanup-isolation.test.ts | RMD-01 |
| `src/__tests__/orchestration-instance-nodeid.test.ts` | `packages/agent-runtime/src/__tests__/orchestration-instance-nodeid.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/orchestration-instance-nodeid.test.ts | RMD-01 |
| `src/__tests__/orchestration-instance-rollback.test.ts` | `packages/agent-runtime/src/__tests__/orchestration-instance-rollback.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/orchestration-instance-rollback.test.ts | RMD-01 |
| `src/__tests__/orchestration-machine-cleanup.test.ts` | `packages/agent-runtime/src/__tests__/orchestration-machine-cleanup.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/orchestration-machine-cleanup.test.ts | RMD-01 |
...
| `src/__tests__/registry-environment-isolation-coverage.test.ts` | `packages/agent-runtime/src/__tests__/registry-environment-isolation-coverage.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/registry-environment-isolation-coverage.test.ts | RMD-01 |
| `src/__tests__/registry-filews-cleanup.test.ts` | `packages/resources/machine/src/__tests__/registry-filews-cleanup.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/registry-filews-cleanup.test.ts | RMD-02 |
| `src/__tests__/registry-machine-stages.test.ts` | `packages/resources/machine/src/__tests__/registry-machine-stages.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/registry-machine-stages.test.ts | RMD-02 |
| `src/__tests__/registry-routes-isolation.test.ts` | `packages/resources/machine/src/__tests__/registry-routes-isolation.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/registry-routes-isolation.test.ts | RMD-02 |
| `src/__tests__/registry-routes.test.ts` | `packages/resources/machine/src/__tests__/registry-routes.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/registry-routes.test.ts | RMD-02 |
| `src/__tests__/registry-schema.test.ts` | `packages/resources/machine/src/__tests__/registry-schema.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/registry-schema.test.ts | RMD-02 |
| `src/__tests__/registry-service.test.ts` | `packages/resources/machine/src/__tests__/registry-service.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/registry-service.test.ts | RMD-02 |
| `src/__tests__/resource-permission-service.test.ts` | `packages/platform/access-control/src/__tests__/resource-permission-service.test.ts` | platform-access-control | 无仓内生产 importer；RMD-06 接线时确认 packages/platform/access-control 公开入口 | src/__tests__/resource-permission-service.test.ts | RMD-06 |
...
| `src/__tests__/round19-registry-service-boundaries.test.ts` | `packages/resources/machine/src/__tests__/round19-registry-service-boundaries.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/round19-registry-service-boundaries.test.ts | RMD-02 |
...
| `src/__tests__/round23-resource-permission-isolation.test.ts` | `packages/platform/access-control/src/__tests__/round23-resource-permission-isolation.test.ts` | platform-access-control | 无仓内生产 importer；RMD-06 接线时确认 packages/platform/access-control 公开入口 | src/__tests__/round23-resource-permission-isolation.test.ts | RMD-06 |
...
| `src/__tests__/round36-registry-service-coverage.test.ts` | `packages/resources/machine/src/__tests__/round36-registry-service-coverage.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/round36-registry-service-coverage.test.ts | RMD-02 |
...
| `src/__tests__/round39-registry-service.test.ts` | `packages/resources/machine/src/__tests__/round39-registry-service.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/round39-registry-service.test.ts | RMD-02 |
| `src/__tests__/round43-launch-spec-builder.test.ts` | `packages/agent-runtime/src/__tests__/round43-launch-spec-builder.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/round43-launch-spec-builder.test.ts | RMD-01 |
| `src/__tests__/round44-environments-routes.test.ts` | `packages/agent-runtime/src/__tests__/round44-environments-routes.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/round44-environments-routes.test.ts | RMD-01 |
| `src/__tests__/round44-launch-spec-builder-config.test.ts` | `packages/agent-runtime/src/__tests__/round44-launch-spec-builder-config.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/round44-launch-spec-builder-config.test.ts | RMD-01 |
...
| `src/__tests__/round45-environment-acp.test.ts` | `packages/agent-runtime/src/__tests__/round45-environment-acp.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/round45-environment-acp.test.ts | RMD-01 |
...
| `src/__tests__/round64-resource-permission-repository.test.ts` | `packages/platform/access-control/src/__tests__/round64-resource-permission-repository.test.ts` | platform-access-control | 无仓内生产 importer；RMD-06 接线时确认 packages/platform/access-control 公开入口 | src/__tests__/round64-resource-permission-repository.test.ts | RMD-06 |
| `src/__tests__/round68-registry-heartbeat.test.ts` | `packages/resources/machine/src/__tests__/round68-registry-heartbeat.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | src/__tests__/round68-registry-heartbeat.test.ts | RMD-02 |
| `src/__tests__/sandbox-api-error-mapping.test.ts` | `packages/resources/sandbox/src/__tests__/sandbox-api-error-mapping.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/sandbox-api-error-mapping.test.ts | RMD-03 |
| `src/__tests__/sandbox-cluster-admin-service.test.ts` | `packages/resources/sandbox/src/__tests__/sandbox-cluster-admin-service.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/sandbox-cluster-admin-service.test.ts | RMD-03 |
| `src/__tests__/sandbox-config.test.ts` | `packages/resources/sandbox/src/__tests__/sandbox-config.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/sandbox-config.test.ts | RMD-03 |
| `src/__tests__/sandbox-default-pool.test.ts` | `packages/resources/sandbox/src/__tests__/sandbox-default-pool.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/sandbox-default-pool.test.ts | RMD-03 |
| `src/__tests__/sandbox-execution-handler.test.ts` | `packages/resources/sandbox/src/__tests__/sandbox-execution-handler.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/sandbox-execution-handler.test.ts | RMD-03 |
| `src/__tests__/sandbox-manager.test.ts` | `packages/resources/sandbox/src/__tests__/sandbox-manager.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/sandbox-manager.test.ts | RMD-03 |
| `src/__tests__/sandbox-pool-config-api.test.ts` | `packages/resources/sandbox/src/__tests__/sandbox-pool-config-api.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/sandbox-pool-config-api.test.ts | RMD-03 |
| `src/__tests__/sandbox-provider-registry.test.ts` | `packages/resources/sandbox/src/__tests__/sandbox-provider-registry.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/sandbox-provider-registry.test.ts | RMD-03 |
| `src/__tests__/sandbox-schema.test.ts` | `packages/resources/sandbox/src/__tests__/sandbox-schema.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/sandbox-schema.test.ts | RMD-03 |
| `src/__tests__/sandbox-server-admin-service.test.ts` | `packages/resources/sandbox/src/__tests__/sandbox-server-admin-service.test.ts` | resource-sandbox | 无仓内生产 importer；RMD-03 接线时确认 packages/resources/sandbox 公开入口 | src/__tests__/sandbox-server-admin-service.test.ts | RMD-03 |
...
| `src/__tests__/session-async-cleanup.test.ts` | `packages/agent-runtime/src/__tests__/session-async-cleanup.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/session-async-cleanup.test.ts | RMD-01 |
| `src/__tests__/session-state-service.test.ts` | `packages/agent-runtime/src/__tests__/session-state-service.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/session-state-service.test.ts | RMD-01 |
| `src/__tests__/session-sync-functions.test.ts` | `packages/agent-runtime/src/__tests__/session-sync-functions.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/session-sync-functions.test.ts | RMD-01 |
| `src/__tests__/sidebar-config-service.test.ts` | `packages/resources/agent-config/src/__tests__/sidebar-config-service.test.ts` | agent-config | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/agent-config 公开入口 | src/__tests__/sidebar-config-service.test.ts | RMD-04 |
...
| `src/__tests__/transport-normalize.test.ts` | `packages/agent-runtime/src/__tests__/transport-normalize.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/transport-normalize.test.ts | RMD-01 |
...
| `src/__tests__/web-sidebar-config-routes.test.ts` | `packages/resources/agent-config/src/__tests__/web-sidebar-config-routes.test.ts` | agent-config | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/agent-config 公开入口 | src/__tests__/web-sidebar-config-routes.test.ts | RMD-04 |
...
| `src/__tests__/yjs-frontend-snapshot-persist.test.ts` | `packages/agent-runtime/src/__tests__/yjs-frontend-snapshot-persist.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/yjs-frontend-snapshot-persist.test.ts | RMD-01 |
| `src/.DS_Store` | 删除 | delete | 删除：非源码产物 | scripts/__tests__/root-source-owner-inventory.test.ts | RMD-09 |
| `src/errors/index.ts` | `apps/server/src/errors/index.ts` | apps-server | 无仓内生产 importer；RMD-07 接线时确认 apps/server 公开入口 | 无直接专项测试；RMD-07 迁移验收 | RMD-07 |
...
| `src/repositories/index.ts` | `apps/server/src/repositories/index.ts` | apps-server | apps/server/src/auth/token.ts; apps/server/src/test-utils/setup-mocks.ts; packages/platform/access-control/src/resource-permission.ts; packages/resources/observer/src/server/services/observer/observer-service.ts; src/services/acp-idle-monitor.ts; src/services/orchestration-bootstrap.ts | apps/server/src/__tests__/auth.test.ts | RMD-07 |
| `src/repositories/resource-permission.ts` | `packages/platform/access-control/src/repositories/resource-permission.ts` | platform-access-control | apps/server/src/test-utils/stubs/resource-permission-repo-stub.ts; packages/platform/access-control/src/resource-permission.ts; src/repositories/index.ts | src/__tests__/resource-permission-service.test.ts, src/__tests__/round23-resource-permission-isolation.test.ts | RMD-06 |
| `src/repositories/share-link.ts` | `packages/resources/identity-admin/src/repositories/share-link.ts` | identity-admin | src/repositories/index.ts | src/__tests__/round19-isolated-repository-boundaries.test.ts | RMD-06 |
| `src/repositories/token.ts` | `packages/resources/identity-admin/src/repositories/token.ts` | identity-admin | src/repositories/index.ts | 无直接专项测试；RMD-06 迁移验收 | RMD-06 |
| `src/repositories/user.ts` | `packages/resources/identity-admin/src/repositories/user.ts` | identity-admin | packages/resources/model-management/src/server/model-gateway/runtime.ts; packages/resources/sandbox/src/server/services/sandbox-admin-service.ts; src/repositories/index.ts | 无直接专项测试；RMD-06 迁移验收 | RMD-06 |
| `src/routes/acp/index.ts` | `packages/agent-runtime/src/routes/acp/index.ts` | agent-runtime | apps/server/src/main.ts | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `src/routes/api/instances.ts` | `packages/agent-runtime/src/routes/api/instances.ts` | agent-runtime | apps/server/src/main.ts | src/__tests__/api-instance-routes.test.ts | RMD-01 |
| `src/routes/api/models.ts` | `packages/resources/model-management/src/routes/api/models.ts` | model-management | apps/server/src/main.ts | 无直接专项测试；RMD-04 迁移验收 | RMD-04 |
| `src/routes/api/openai-chat.ts` | `packages/agent-runtime/src/routes/api/openai-chat.ts` | agent-runtime | apps/server/src/main.ts | src/__tests__/openai-chat-routes.test.ts | RMD-01 |
| `src/routes/api/sandbox-cluster.ts` | `packages/resources/sandbox/src/routes/api/sandbox-cluster.ts` | resource-sandbox | apps/server/src/main.ts; src/routes/api/sandbox-server.ts | 无直接专项测试；RMD-03 迁移验收 | RMD-03 |
| `src/routes/api/sandbox-server.ts` | `packages/resources/sandbox/src/routes/api/sandbox-server.ts` | resource-sandbox | apps/server/src/main.ts | src/__tests__/api-sandbox-server.test.ts | RMD-03 |
| `src/routes/api/sandbox.ts` | `packages/resources/sandbox/src/routes/api/sandbox.ts` | resource-sandbox | apps/server/src/main.ts | src/__tests__/sandbox-api-error-mapping.test.ts | RMD-03 |
| `src/routes/api/workspaces.ts` | `packages/resources/machine/src/routes/api/workspaces.ts` | resource-machine | apps/server/src/main.ts | packages/resources/machine/src/server/__tests__/api-workspace-routes.test.ts | RMD-02 |
...
| `src/routes/web/config/models.ts` | `packages/resources/model-management/src/routes/web/config/models.ts` | model-management | src/routes/web/config/index.ts; src/routes/web/config/providers.ts | 无直接专项测试；RMD-04 迁移验收 | RMD-04 |
...
| `src/routes/web/control.ts` | `packages/resources/identity-admin/src/routes/web/control.ts` | identity-admin | 无仓内生产 importer；RMD-06 接线时确认 packages/resources/identity-admin 公开入口 | 无直接专项测试；RMD-06 迁移验收 | RMD-06 |
| `src/routes/web/environments.ts` | `apps/server/src/routes/web/environments.ts` | apps-server | src/routes/web/index.ts | src/__tests__/round44-environments-routes.test.ts | RMD-07 |
| `src/routes/web/file-events.ts` | `packages/resources/machine/src/routes/web/file-events.ts` | resource-machine | src/routes/web/index.ts | packages/resources/machine/src/server/__tests__/file-events-endpoint.test.ts | RMD-02 |
| `src/routes/web/fs.ts` | `packages/resources/machine/src/routes/web/fs.ts` | resource-machine | src/routes/web/index.ts | packages/resources/machine/src/server/__tests__/fs-etag.test.ts, packages/resources/machine/src/server/__tests__/fs-opid-ifmatch.test.ts, packages/resources/machine/src/server/__tests__/fs-read-mode.test.ts, packages/resources/machine/src/server/__tests__/fs-routes-converged.test.ts, packages/resources/machine/src/server/__tests__/fs-upload-limit.test.ts, packages/resources/machine/src/server/__tests__/fs-zip-remote.test.ts, src/__tests__/fs-symlink-escape.test.ts, src/__tests__/fs-upload-escape.test.ts | RMD-02 |
| `src/routes/web/index.ts` | `apps/server/src/routes/web/index.ts` | apps-server | apps/server/src/main.ts | src/__tests__/agent-platform-api-reference.test.ts, src/__tests__/registry-routes.test.ts | RMD-07 |
| `src/routes/web/instances.ts` | `apps/server/src/routes/web/instances.ts` | apps-server | src/routes/web/index.ts | src/__tests__/instances-delete-idempotent.test.ts, src/__tests__/web-instance-runtime-actions.test.ts | RMD-07 |
...
| `src/routes/web/registry.ts` | `packages/resources/machine/src/routes/web/registry.ts` | resource-machine | src/routes/web/index.ts | src/__tests__/registry-routes-isolation.test.ts, src/__tests__/registry-routes.test.ts, src/__tests__/round19-registry-service-boundaries.test.ts | RMD-02 |
| `src/routes/web/sidebar-config.ts` | `packages/resources/agent-config/src/routes/web/sidebar-config.ts` | agent-config | src/routes/web/index.ts | src/__tests__/web-sidebar-config-routes.test.ts | RMD-04 |
| `src/schemas/acp.schema.ts` | `packages/agent-runtime/src/schemas/acp.schema.ts` | agent-runtime | src/schemas/index.ts | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `src/schemas/api-common.schema.ts` | `apps/server/src/schemas/api-common.schema.ts` | apps-server | packages/resources/mcp/src/server/routes/api/mcp.ts; packages/resources/workflow/src/server/schemas/api-common.schema.ts; src/routes/api/models.ts; src/routes/api/sandbox-cluster.ts; src/routes/api/sandbox-server.ts; src/routes/api/sandbox.ts | 无直接专项测试；RMD-07 迁移验收 | RMD-07 |
| `src/schemas/api-instance.schema.ts` | `apps/server/src/schemas/api-instance.schema.ts` | apps-server | src/routes/api/instances.ts | 无直接专项测试；RMD-07 迁移验收 | RMD-07 |
| `src/schemas/api-model.schema.ts` | `apps/server/src/schemas/api-model.schema.ts` | apps-server | src/routes/api/models.ts | 无直接专项测试；RMD-07 迁移验收 | RMD-07 |
| `src/schemas/api-workspace.schema.ts` | `apps/server/src/schemas/api-workspace.schema.ts` | apps-server | src/routes/api/workspaces.ts | 无直接专项测试；RMD-07 迁移验收 | RMD-07 |
| `src/schemas/common.schema.ts` | `apps/server/src/schemas/common.schema.ts` | apps-server | packages/resources/agent-config/src/server/routes/web/agent-generation.ts; packages/resources/agent-config/src/server/routes/web/agent-site-association-routes.ts; packages/resources/agent-config/src/server/routes/web/agent-site-route-support.ts; packages/resources/agent-config/src/server/routes/web/agent-sites.ts; packages/resources/agent-config/src/server/routes/web/config/agents.ts; packages/resources/agent-config/src/server/schemas/agent-generation.schema.ts; packages/resources/agent-config/src/server/schemas/agent-site.schema.ts; packages/resources/agent-config/src/server/schemas/config.schema.ts; packages/resources/channel/src/server/schemas/common.schema.ts; packages/resources/identity-admin/src/server/routes/web/api-keys.ts; packages/resources/identity-admin/src/server/routes/web/organizations.ts; packages/resources/identity-admin/src/server/schemas/organization.schema.ts; packages/resources/knowledge/src/server/routes/web/knowledge-bases.ts; packages/resources/knowledge/src/server/schemas/knowledge.schema.ts; packages/resources/mcp/src/server/routes/web/config/mcp.ts; packages/resources/prod-view/src/server/routes/web/config/prod-views.ts; packages/resources/prod-view/src/server/routes/web/prod-views.ts; packages/resources/skill/src/server/routes/web/config/skills.ts; packages/resources/task/src/server/schemas/common.schema.ts; packages/resources/workflow/src/server/schemas/common.schema.ts; src/routes/web/config/models.ts; src/routes/web/config/providers.ts; src/routes/web/control.ts; src/routes/web/environments.ts; src/routes/web/instances.ts; src/routes/web/meta-agent.ts; src/routes/web/peri-task-details.ts; src/routes/web/registry.ts; src/schemas/config.schema.ts; src/schemas/environment.schema.ts; src/schemas/file.schema.ts; src/schemas/index.ts; src/schemas/instance.schema.ts; src/schemas/peri-task-details.ts; src/schemas/registry.schema.ts; src/schemas/session.schema.ts | packages/resources/agent-config/src/__tests__/agent-sites-routes.test.ts, src/__tests__/round16-isolated-protocol-boundaries.test.ts | RMD-07 |
| `src/schemas/config.schema.ts` | `apps/server/src/schemas/config.schema.ts` | apps-server | src/routes/web/config/models.ts; src/routes/web/config/providers.ts; src/schemas/index.ts | 无直接专项测试；RMD-07 迁移验收 | RMD-07 |
| `src/schemas/environment.schema.ts` | `packages/agent-runtime/src/schemas/environment.schema.ts` | agent-runtime | src/routes/web/environments.ts; src/schemas/index.ts | src/__tests__/environment-schema.test.ts | RMD-01 |
| `src/schemas/file-events.schema.ts` | `packages/resources/machine/src/schemas/file-events.schema.ts` | resource-machine | src/routes/web/file-events.ts | 无直接专项测试；RMD-02 迁移验收 | RMD-02 |
| `src/schemas/file.schema.ts` | `packages/resources/machine/src/schemas/file.schema.ts` | resource-machine | src/routes/web/fs.ts; src/schemas/api-workspace.schema.ts; src/schemas/index.ts | 无直接专项测试；RMD-02 迁移验收 | RMD-02 |
| `src/schemas/index.ts` | `apps/server/src/schemas/index.ts` | apps-server | packages/resources/skill/src/server/routes/web/config/skills.ts; src/routes/acp/index.ts; src/routes/web/sidebar-config.ts | src/__tests__/registry-routes.test.ts | RMD-07 |
| `src/schemas/instance.schema.ts` | `packages/agent-runtime/src/schemas/instance.schema.ts` | agent-runtime | src/routes/web/instances.ts; src/schemas/index.ts | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `src/schemas/meta-agent.schema.ts` | `packages/resources/agent-config/src/schemas/meta-agent.schema.ts` | agent-config | src/routes/web/meta-agent.ts; src/schemas/index.ts | 无直接专项测试；RMD-04 迁移验收 | RMD-04 |
| `src/schemas/openai-chat.schema.ts` | `packages/agent-runtime/src/schemas/openai-chat.schema.ts` | agent-runtime | src/routes/api/openai-chat.ts; src/schemas/index.ts; src/services/openai-response-mapper.ts | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `src/schemas/peri-task-details.ts` | `apps/server/src/schemas/peri-task-details.ts` | apps-server | src/routes/web/peri-task-details.ts; src/schemas/index.ts; src/services/peri-task-detail-service.ts | 无直接专项测试；RMD-07 迁移验收 | RMD-07 |
| `src/schemas/registry.schema.ts` | `packages/resources/machine/src/schemas/registry.schema.ts` | resource-machine | src/routes/web/registry.ts; src/schemas/index.ts | src/__tests__/registry-routes.test.ts, src/__tests__/registry-schema.test.ts, src/__tests__/round19-registry-service-boundaries.test.ts | RMD-02 |
| `src/schemas/resource-access.schema.ts` | `packages/platform/access-control/src/schemas/resource-access.schema.ts` | platform-access-control | packages/resources/agent-config/src/server/schemas/api-agent.schema.ts; packages/resources/agent-config/src/server/schemas/config.schema.ts; packages/resources/mcp/src/server/schemas/api-mcp.schema.ts; packages/resources/skill/src/server/schemas/api-skill.schema.ts; src/schemas/api-model.schema.ts; src/schemas/config.schema.ts | 无直接专项测试；RMD-06 迁移验收 | RMD-06 |
| `src/schemas/session.schema.ts` | `apps/server/src/schemas/session.schema.ts` | apps-server | src/routes/web/control.ts; src/schemas/index.ts | 无直接专项测试；RMD-07 迁移验收 | RMD-07 |
...
| `src/services/acp-idle-monitor.ts` | `packages/agent-runtime/src/services/acp-idle-monitor.ts` | agent-runtime | apps/server/src/main.ts; packages/agent-runtime/src/server/services/chat-channel-bootstrap.ts; packages/agent-runtime/src/server/transport/acp-ws-handler.ts; packages/agent-runtime/src/server/transport/relay/external-relay.ts; packages/resources/workflow/src/server/services/workflow/agent-chat-transport.ts; src/routes/web/instances.ts | packages/resources/workflow/src/__tests__/agent-chat-transport.test.ts, packages/resources/workflow/src/__tests__/round57-agent-chat-transport.test.ts, src/__tests__/acp-idle-monitor.test.ts, src/__tests__/round15-isolated-service-boundaries.test.ts | RMD-01 |
| `src/services/agent-chat-service.ts` | `packages/agent-runtime/src/services/agent-chat-service.ts` | agent-runtime | packages/resources/task/src/server/services/scheduler/agent-executor.ts; packages/resources/workflow/src/server/services/workflow/agent-chat-transport.ts; src/routes/api/openai-chat.ts | packages/resources/task/src/__tests__/agent-executor.test.ts, packages/resources/workflow/src/__tests__/agent-chat-transport.test.ts, packages/resources/workflow/src/__tests__/round57-agent-chat-transport.test.ts, packages/resources/workflow/src/__tests__/round68-agent-chat-transport-coverage.test.ts, src/__tests__/agent-chat-service-boundaries.test.ts, src/__tests__/agent-chat-service-concurrency.test.ts, src/__tests__/openai-chat-routes.test.ts, src/__tests__/openai-chat-service.test.ts | RMD-01 |
| `src/services/agent-concurrency.ts` | `packages/agent-runtime/src/services/agent-concurrency.ts` | agent-runtime | src/services/acp-idle-monitor.ts; src/services/orchestration-instance.ts | src/__tests__/agent-concurrency-toctou.test.ts, src/__tests__/agent-concurrency.test.ts, src/__tests__/instance-concurrency.test.ts | RMD-01 |
...
| `src/services/chat-channel-error-classify.ts` | `packages/chat-channel/src/services/chat-channel-error-classify.ts` | chat-channel | packages/agent-runtime/src/server/services/chat-channel-bootstrap.ts | src/__tests__/round15-isolated-service-boundaries.test.ts, src/__tests__/round16-isolated-protocol-boundaries.test.ts | RMD-01 |
| `src/services/config-utils.ts` | `apps/server/src/services/config-utils.ts` | apps-server | packages/resources/agent-config/src/server/routes/web/agent-generation.ts; packages/resources/agent-config/src/server/routes/web/config/agent-route-support.ts; packages/resources/memory/src/server/routes/web/hindsight.ts; packages/resources/skill/src/server/routes/web/config/skills.ts; src/routes/web/config/models.ts; src/routes/web/config/providers.ts; src/routes/web/config/sandbox-pools.ts; src/services/launch-spec-builder.ts | src/__tests__/round16-isolated-protocol-boundaries.test.ts, src/__tests__/round22-launch-spec-isolation.test.ts | RMD-07 |
...
| `src/services/config/types.ts` | `apps/server/src/services/config/types.ts` | apps-server | apps/server/src/env.ts; packages/resources/mcp/src/server/routes/web/config/mcp.ts; packages/resources/mcp/src/server/services/config/mcp-server.ts; packages/resources/model-management/src/server/config/model-provider-types.ts; packages/resources/model-management/src/server/config/provider.ts; src/routes/web/config/models.ts; src/services/config/index.ts; src/services/config/user-config.ts; src/services/meta-agent.ts | src/__tests__/engine-type-schema.test.ts | RMD-07 |
| `src/services/config/user-config.ts` | `apps/server/src/services/config/user-config.ts` | apps-server | packages/resources/agent-config/src/server/routes/web/config/agent-route-support.ts; src/routes/web/config/models.ts; src/services/config/index.ts | 无直接专项测试；RMD-07 迁移验收 | RMD-07 |
| `src/services/core-bootstrap.ts` | `apps/server/src/services/core-bootstrap.ts` | apps-server | apps/server/src/main.ts; src/services/acp-idle-monitor.ts; src/services/agent-concurrency.ts; src/services/orchestration-instance.ts | src/__tests__/acp-idle-monitor.test.ts | RMD-07 |
...
| `src/services/doc-manager-instance.ts` | `packages/chat-channel/src/services/doc-manager-instance.ts` | chat-channel | packages/agent-runtime/src/server/services/chat-channel-bootstrap.ts; src/routes/web/peri-task-details.ts; src/services/acp-idle-monitor.ts | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `src/services/environment-acp.ts` | `packages/agent-runtime/src/services/environment-acp.ts` | agent-runtime | packages/agent-runtime/src/server/transport/acp-ws-handler.ts; src/services/environment.ts | src/__tests__/round45-environment-acp.test.ts | RMD-01 |
| `src/services/environment-core.ts` | `packages/agent-runtime/src/services/environment-core.ts` | agent-runtime | packages/agent-runtime/src/server/services/environment-web.ts; packages/resources/machine/src/server/services/agent-file-service.ts; packages/resources/machine/src/server/services/api-workspace.ts; src/services/environment-acp.ts; src/services/environment.ts | src/__tests__/config-validators.test.ts, src/__tests__/environment-role.test.ts, src/__tests__/registry-environment-isolation-coverage.test.ts | RMD-01 |
| `src/services/environment-startup-lock.ts` | `packages/agent-runtime/src/services/environment-startup-lock.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | src/__tests__/environment-startup-lock.test.ts | RMD-01 |
| `src/services/environment.ts` | `packages/agent-runtime/src/services/environment.ts` | agent-runtime | packages/agent-runtime/src/server/transport/acp-ws-handler.ts; packages/resources/mcp/src/server/routes/mcp/knowledge.ts; src/routes/web/environments.ts; src/routes/web/file-events.ts; src/routes/web/instances.ts; src/routes/web/peri-task-details.ts | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `src/services/event-service.ts` | `packages/resources/machine/src/services/event-service.ts` | resource-machine | packages/resources/channel/src/server/services/hermes-client.ts; src/routes/web/control.ts; src/services/session.ts; src/services/transport.ts | packages/resources/channel/src/__tests__/round49-hermes-client.test.ts, src/__tests__/round21-isolated-service-coverage.test.ts | RMD-02 |
| `src/services/instance-registry.ts` | `packages/agent-runtime/src/services/instance-registry.ts` | agent-runtime | packages/agent-runtime/src/server/services/agent-instance-runtime-projection.ts; packages/agent-runtime/src/server/transport/acp-ws-handler.ts; src/services/acp-idle-monitor.ts; src/services/agent-concurrency.ts; src/services/core-bootstrap.ts; src/services/orchestration-instance.ts | packages/resources/agent-config/src/__tests__/agent-config-delete-stops-instances.test.ts, packages/resources/agent-config/src/__tests__/agent-config-delete.test.ts, packages/resources/workflow/src/__tests__/agent-chat-transport.test.ts, packages/resources/workflow/src/__tests__/round57-agent-chat-transport.test.ts, packages/resources/workflow/src/__tests__/round68-agent-chat-transport-coverage.test.ts, packages/resources/workflow/src/__tests__/workflow-cleanup.test.ts, src/__tests__/acp-idle-monitor.test.ts, src/__tests__/agent-concurrency-toctou.test.ts, src/__tests__/agent-concurrency.test.ts, src/__tests__/instance-concurrency.test.ts, src/__tests__/instances-delete-idempotent.test.ts, src/__tests__/orchestration-instance-cleanup-isolation.test.ts, src/__tests__/orchestration-instance-nodeid.test.ts, src/__tests__/orchestration-instance-rollback.test.ts | RMD-01 |
| `src/services/launch-spec-builder.ts` | `packages/agent-runtime/src/services/launch-spec-builder.ts` | agent-runtime | apps/server/src/main.ts; src/services/orchestration-instance.ts | packages/resources/workflow/src/__tests__/workflow-provider-model-access.test.ts, src/__tests__/launch-spec-agent-sharing-access.test.ts, src/__tests__/launch-spec-builder-errors.test.ts, src/__tests__/launch-spec-langfuse-env.test.ts, src/__tests__/launch-spec-mcp-resource-access.test.ts, src/__tests__/launch-spec-model-gateway.test.ts, src/__tests__/launch-spec-provider-model-access.test.ts, src/__tests__/round22-launch-spec-isolation.test.ts, src/__tests__/round43-launch-spec-builder.test.ts, src/__tests__/round44-launch-spec-builder-config.test.ts | RMD-01 |
| `src/services/local-node-service.ts` | `packages/resources/machine/src/services/local-node-service.ts` | resource-machine | src/services/orchestration-bootstrap.ts; src/services/orchestration-instance.ts | src/__tests__/local-node-service.test.ts | RMD-02 |
| `src/services/meta-agent.ts` | `packages/resources/agent-config/src/services/meta-agent.ts` | agent-config | src/routes/web/meta-agent.ts; src/services/sync-builtin.ts | src/__tests__/meta-agent.test.ts | RMD-04 |
| `src/services/openai-response-mapper.ts` | `apps/server/src/services/openai-response-mapper.ts` | apps-server | src/routes/api/openai-chat.ts | src/__tests__/openai-response-mapper.test.ts, src/__tests__/round16-isolated-protocol-boundaries.test.ts, src/__tests__/round18-openai-response-protocol-boundaries.test.ts | RMD-07 |
| `src/services/orchestration-bootstrap.ts` | `packages/agent-runtime/src/services/orchestration-bootstrap.ts` | agent-runtime | packages/agent-runtime/src/server/services/agent-instance-runtime-projection.ts; packages/agent-runtime/src/server/services/agent-instance-service.ts; src/services/orchestration-instance.ts; src/services/orchestration-machine-cleanup.ts | src/__tests__/instances-delete-idempotent.test.ts, src/__tests__/orchestration-bootstrap-resolver.test.ts, src/__tests__/orchestration-machine-cleanup.test.ts | RMD-01 |
| `src/services/orchestration-instance.ts` | `packages/agent-runtime/src/services/orchestration-instance.ts` | agent-runtime | packages/agent-runtime/src/server.ts; packages/agent-runtime/src/server/services/agent-instance-runtime-projection.ts; packages/agent-runtime/src/server/services/agent-instance-service.ts; packages/agent-runtime/src/server/services/chat-channel-bootstrap.ts; packages/agent-runtime/src/server/transport/agent-relay.ts; packages/resources/workflow/src/server/services/workflow/agent-chat-transport.ts; src/services/environment-core.ts | packages/resources/agent-config/src/__tests__/agent-config-delete-stops-instances.test.ts, packages/resources/agent-config/src/__tests__/agent-config-delete.test.ts, packages/resources/workflow/src/__tests__/agent-chat-transport.test.ts, src/__tests__/agent-concurrency-toctou.test.ts, src/__tests__/instance-concurrency.test.ts, src/__tests__/instances-delete-idempotent.test.ts, src/__tests__/local-instance-death-cleanup.test.ts, src/__tests__/orchestration-instance-cleanup-isolation.test.ts, src/__tests__/orchestration-instance-nodeid.test.ts, src/__tests__/orchestration-instance-rollback.test.ts, src/__tests__/round44-environments-routes.test.ts | RMD-01 |
| `src/services/orchestration-machine-cleanup.ts` | `packages/agent-runtime/src/services/orchestration-machine-cleanup.ts` | agent-runtime | src/services/core-bootstrap.ts | src/__tests__/orchestration-machine-cleanup.test.ts | RMD-01 |
| `src/services/peri-task-detail-service.ts` | `packages/resources/model-management/src/services/peri-task-detail-service.ts` | model-management | src/routes/web/peri-task-details.ts | src/__tests__/peri-task-detail-service.test.ts | RMD-04 |
| `src/services/peri-task-detail-store.ts` | `packages/resources/model-management/src/services/peri-task-detail-store.ts` | model-management | src/routes/web/peri-task-details.ts; src/services/peri-task-detail-service.ts | src/__tests__/peri-task-detail-service.test.ts | RMD-04 |
| `src/services/session.ts` | `packages/agent-runtime/src/services/session.ts` | agent-runtime | src/routes/web/control.ts | src/__tests__/session-async-cleanup.test.ts, src/__tests__/session-sync-functions.test.ts | RMD-01 |
| `src/services/sidebar-config.ts` | `packages/resources/agent-config/src/services/sidebar-config.ts` | agent-config | src/routes/web/sidebar-config.ts | src/__tests__/sidebar-config-service.test.ts | RMD-04 |
| `src/services/sync-builtin.ts` | `apps/server/src/services/sync-builtin.ts` | apps-server | apps/server/src/main.ts | src/__tests__/meta-agent.test.ts | RMD-07 |
| `src/services/transport.ts` | `apps/server/src/services/transport.ts` | apps-server | src/routes/web/control.ts | src/__tests__/registry-environment-isolation-coverage.test.ts, src/__tests__/transport-normalize.test.ts | RMD-07 |
| `src/transport/agent-node-bridge.ts` | `packages/agent-runtime/src/transport/agent-node-bridge.ts` | agent-runtime | packages/agent-runtime/src/server/transport/acp-ws-handler.ts; src/services/local-node-service.ts | src/__tests__/agent-node-bridge.test.ts, src/__tests__/agent-node-socket-send.test.ts, src/__tests__/machine-cleanup-node-dispatch.test.ts | RMD-01 |
| `src/transport/event-bus.ts` | `packages/agent-runtime/src/transport/event-bus.ts` | agent-runtime | packages/agent-runtime/src/server/transport/acp-ws-handler.ts; packages/resources/workflow/src/server/services/workflow/workflow-events.ts; src/services/event-service.ts | packages/resources/workflow/src/__tests__/workflow-sse.test.ts, src/__tests__/event-bus.test.ts, src/__tests__/round15-isolated-service-boundaries.test.ts, src/__tests__/round21-isolated-service-coverage.test.ts, src/__tests__/round37-service-boundaries.test.ts | RMD-01 |
| `src/transport/ws-types.ts` | `apps/server/src/transport/ws-types.ts` | apps-server | apps/server/src/test-utils/observer-fixtures.ts; packages/agent-runtime/src/server/transport/acp-ws-handler.ts; packages/agent-runtime/src/server/transport/relay/external-relay.ts; packages/resources/machine/src/server/transport/file-ws-handler.ts; packages/resources/machine/src/server/transport/file-ws-requests.ts; src/routes/acp/index.ts; src/routes/web/file-events.ts; src/transport/agent-node-bridge.ts; src/types/store.ts | src/__tests__/acp-machine-connection-lookup.test.ts, src/__tests__/agent-node-socket-send.test.ts, src/__tests__/external-relay.test.ts, src/__tests__/registry-filews-cleanup.test.ts | RMD-07 |
| `src/types/api.ts` | `apps/server/src/types/api.ts` | apps-server | src/services/automationState.ts; src/services/environment-acp.ts; src/services/environment-core.ts | src/__tests__/automationState.test.ts | RMD-07 |
...
| `src/types/store.ts` | `apps/server/src/types/store.ts` | apps-server | apps/server/src/test-utils/observer-fixtures.ts; packages/agent-runtime/src/server/services/agent-instance-runtime-projection.ts; packages/agent-runtime/src/server/transport/acp-ws-handler.ts; packages/resources/machine/src/server/services/file-machine-events.ts; packages/resources/machine/src/server/transport/file-ws-requests.ts; packages/resources/observer/src/server/services/observer/observer-service.ts; packages/resources/observer/src/server/services/observer/providers/acp-link.ts; packages/resources/observer/src/server/services/observer/types.ts; src/services/agent-chat-service.ts; src/services/agent-concurrency.ts; src/services/instance-registry.ts; src/services/orchestration-instance.ts | packages/resources/observer/src/__tests__/api-system-observer-links.test.ts, packages/resources/workflow/src/__tests__/agent-chat-transport.test.ts, src/__tests__/acp-machine-connection-lookup.test.ts, src/__tests__/agent-concurrency.test.ts, src/__tests__/orchestration-instance-cleanup-isolation.test.ts | RMD-07 |
...
| `web/components/ACPMain.tsx` | `packages/chat-channel/web/components/ACPMain.tsx` | chat-channel | packages/agent-runtime/web/agent-panel/ChatPanel.tsx | web/src/__tests__/acp-main-session-recovery.test.tsx | RMD-01 |
...
| `web/components/ChangePasswordDialog.tsx` | `packages/resources/identity-admin/web/components/ChangePasswordDialog.tsx` | identity-admin | web/src/pages/agent-panel/AgentSidebar.tsx | 无直接专项测试；RMD-06 迁移验收 | RMD-06 |
| `web/components/ChatInterface.tsx` | `packages/chat-channel/web/components/ChatInterface.tsx` | chat-channel | web/components/ACPMain.tsx | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
...
| `web/components/config/ConfirmDialog.tsx` | `apps/web/components/config/ConfirmDialog.tsx` | apps-web | packages/resources/agent-config/web/pages/agent-panel/pages/AgentSitesPage.tsx; packages/resources/channel/web/pages/agent-panel/pages/AgentChannelsPage.tsx; packages/resources/identity-admin/web/pages/agent-panel/pages/AgentApiKeysPage.tsx; packages/resources/knowledge/web/pages/agent-panel/pages/AgentKnowledgeBasesPage.tsx; packages/resources/mcp/web/pages/agent-panel/pages/AgentMcpPage.tsx; packages/resources/model-management/web/pages/admin/ModelGatewayKeyManagementPanel.tsx; packages/resources/model-management/web/pages/agent-panel/pages/agent-models-dialogs.tsx; packages/resources/prod-view/web/pages/agent-panel/ProdViewsPanel.tsx; packages/resources/prod-view/web/pages/agent-panel/pages/AgentProdViewsPage.tsx; packages/resources/skill/web/pages/agent-panel/pages/agent-skills-dialogs.tsx; packages/resources/task/web/pages/agent-panel/pages/AgentTasksPage.tsx; packages/resources/workflow/web/pages/workflow/WorkflowEditor.tsx; packages/resources/workflow/web/pages/workflow/WorkflowList.tsx; packages/resources/workflow/web/pages/workflow/WorkflowVersions.tsx; packages/resources/workflow/web/pages/workflow/components/VersionIndicator.tsx; packages/resources/workflow/web/pages/workflow/components/VersionPanel.tsx; web/components/config/index.ts; web/src/components/agent-panel/file-tree-view.tsx; web/src/pages/admin/AdminSandboxPage.tsx; web/src/pages/admin/components/RemoteSandboxPanel.tsx | web/src/__tests__/confirm-dialog.test.tsx | RMD-08 |
...
| `web/components/ContextPanel.tsx` | `packages/chat-channel/web/components/ContextPanel.tsx` | chat-channel | web/components/ChatInterface.tsx | web/src/__tests__/context-panel-ssr.test.tsx | RMD-01 |
...
| `web/src/__tests__/acp-main-session-recovery.test.tsx` | `packages/chat-channel/web/src/__tests__/acp-main-session-recovery.test.tsx` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | web/src/__tests__/acp-main-session-recovery.test.tsx | RMD-01 |
...
| `web/src/__tests__/agent-editor-model.test.ts` | `packages/resources/model-management/web/src/__tests__/agent-editor-model.test.ts` | model-management | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/model-management 公开入口 | web/src/__tests__/agent-editor-model.test.ts | RMD-04 |
...
| `web/src/__tests__/agent-sidebar-config-filter-pure.test.ts` | `packages/resources/agent-config/web/src/__tests__/agent-sidebar-config-filter-pure.test.ts` | agent-config | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/agent-config 公开入口 | web/src/__tests__/agent-sidebar-config-filter-pure.test.ts | RMD-04 |
| `web/src/__tests__/agent-sidebar-config.test.ts` | `packages/resources/agent-config/web/src/__tests__/agent-sidebar-config.test.ts` | agent-config | 无仓内生产 importer；RMD-04 接线时确认 packages/resources/agent-config 公开入口 | web/src/__tests__/agent-sidebar-config.test.ts | RMD-04 |
...
| `web/src/__tests__/chat-area-environment-deletion.test.tsx` | `packages/chat-channel/web/src/__tests__/chat-area-environment-deletion.test.tsx` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | web/src/__tests__/chat-area-environment-deletion.test.tsx | RMD-01 |
| `web/src/__tests__/chat-stats.test.tsx` | `packages/chat-channel/web/src/__tests__/chat-stats.test.tsx` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | web/src/__tests__/chat-stats.test.tsx | RMD-01 |
...
| `web/src/__tests__/context-panel-ssr.test.tsx` | `packages/resources/knowledge/web/src/__tests__/context-panel-ssr.test.tsx` | resource-knowledge | 无仓内生产 importer；RMD-05 接线时确认 packages/resources/knowledge 公开入口 | web/src/__tests__/context-panel-ssr.test.tsx | RMD-05 |
...
| `web/src/__tests__/file-icon-and-card-registry-pure.test.ts` | `packages/resources/machine/web/src/__tests__/file-icon-and-card-registry-pure.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | web/src/__tests__/file-icon-and-card-registry-pure.test.ts | RMD-02 |
| `web/src/__tests__/file-icon-helper-round39.test.ts` | `packages/resources/machine/web/src/__tests__/file-icon-helper-round39.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | web/src/__tests__/file-icon-helper-round39.test.ts | RMD-02 |
| `web/src/__tests__/file-picker-dialog.test.tsx` | `packages/resources/machine/web/src/__tests__/file-picker-dialog.test.tsx` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | web/src/__tests__/file-picker-dialog.test.tsx | RMD-02 |
| `web/src/__tests__/file-picker-round49-pure.test.ts` | `packages/resources/machine/web/src/__tests__/file-picker-round49-pure.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | web/src/__tests__/file-picker-round49-pure.test.ts | RMD-02 |
| `web/src/__tests__/file-tree-dialog.test.ts` | `packages/resources/machine/web/src/__tests__/file-tree-dialog.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | web/src/__tests__/file-tree-dialog.test.ts | RMD-02 |
| `web/src/__tests__/file-tree-model.test.ts` | `packages/resources/machine/web/src/__tests__/file-tree-model.test.ts` | resource-machine | 无仓内生产 importer；RMD-02 接线时确认 packages/resources/machine 公开入口 | web/src/__tests__/file-tree-model.test.ts | RMD-02 |
...
| `web/src/__tests__/message.ssr.test.tsx` | `packages/agent-runtime/web/src/__tests__/message.ssr.test.tsx` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | web/src/__tests__/message.ssr.test.tsx | RMD-01 |
...
| `web/src/__tests__/structured-to-thread.test.ts` | `packages/chat-channel/web/src/__tests__/structured-to-thread.test.ts` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | web/src/__tests__/structured-to-thread.test.ts | RMD-01 |
...
| `web/src/__tests__/token-manager-dialog-form.test.ts` | `packages/resources/identity-admin/web/src/__tests__/token-manager-dialog-form.test.ts` | identity-admin | 无仓内生产 importer；RMD-06 接线时确认 packages/resources/identity-admin 公开入口 | web/src/__tests__/token-manager-dialog-form.test.ts | RMD-06 |
| `web/src/__tests__/token-stats.test.ts` | `packages/resources/identity-admin/web/src/__tests__/token-stats.test.ts` | identity-admin | 无仓内生产 importer；RMD-06 接线时确认 packages/resources/identity-admin 公开入口 | web/src/__tests__/token-stats.test.ts | RMD-06 |
| `web/src/__tests__/tool-semantic.test.ts` | `packages/agent-runtime/web/src/__tests__/tool-semantic.test.ts` | agent-runtime | 无仓内生产 importer；RMD-01 接线时确认 packages/agent-runtime 公开入口 | web/src/__tests__/tool-semantic.test.ts | RMD-01 |
...
| `web/src/api/fs.ts` | `apps/web/src/api/fs.ts` | apps-web | packages/agent-runtime/web/components/chat/FilePickerPanel.tsx; packages/agent-runtime/web/components/chat/composer-file-processing.ts; packages/agent-runtime/web/components/chat/useDragUpload.ts; web/src/components/agent-panel/FileTreeTab.tsx; web/src/components/agent-panel/file-tree-model.ts; web/src/components/agent-panel/use-file-uploads.ts | web/src/__tests__/agent-form-dialog-pure-logic.test.ts, web/src/__tests__/api-client.test.ts, web/src/__tests__/file-picker-dialog.test.tsx, web/src/__tests__/folder-upload-batching.test.ts, web/src/__tests__/fs-upload-url.test.ts | RMD-08 |
...
| `web/src/api/meta-agent.ts` | `packages/resources/agent-config/web/src/api/meta-agent.ts` | agent-config | web/src/hooks/useMetaAgent.ts; web/src/pages/agent-panel/AgentSidebarTree.tsx | 无直接专项测试；RMD-04 迁移验收 | RMD-04 |
...
| `web/src/api/sandbox-pools.ts` | `packages/resources/sandbox/web/src/api/sandbox-pools.ts` | resource-sandbox | packages/resources/agent-config/web/pages/agent-panel/agent-editor/use-agent-editor.ts | 无直接专项测试；RMD-03 迁移验收 | RMD-03 |
| `web/src/api/sidebar-config.ts` | `packages/resources/agent-config/web/src/api/sidebar-config.ts` | agent-config | web/src/pages/agent-panel/AgentSidebarConfig.tsx | 无直接专项测试；RMD-04 迁移验收 | RMD-04 |
| `web/src/api/system-sandbox.ts` | `packages/resources/sandbox/web/src/api/system-sandbox.ts` | resource-sandbox | web/src/pages/admin/AdminSandboxPage.tsx; web/src/pages/admin/components/RemoteSandboxPanel.tsx | web/src/__tests__/system-sandbox.test.ts | RMD-03 |
...
| `web/src/components/agent-panel/file-tree-model.ts` | `apps/web/src/components/agent-panel/file-tree-model.ts` | apps-web | web/src/components/agent-panel/FileTreeTab.tsx; web/src/components/agent-panel/file-tree-view.tsx; web/src/components/agent-panel/use-file-uploads.ts | web/src/__tests__/file-tree-model.test.ts | RMD-08 |
...
| `web/src/components/agent-panel/FileTreeTab.tsx` | `apps/web/src/components/agent-panel/FileTreeTab.tsx` | apps-web | web/src/components/agent-panel/artifacts-files-workspace.tsx; web/src/pages/agent-panel/ArtifactsPanel.tsx | web/src/__tests__/file-tree-dialog.test.ts | RMD-08 |
...
| `web/src/components/agent-panel/SiteFrame.tsx` | `packages/resources/agent-config/web/components/agent-panel/SiteFrame.tsx` | agent-config | web/src/pages/agent-panel/ArtifactsPanel.tsx | 无直接专项测试；RMD-05 迁移验收 | RMD-05 |
| `web/src/components/agent-panel/SiteTabsBar.tsx` | `packages/resources/agent-config/web/components/agent-panel/SiteTabsBar.tsx` | agent-config | web/src/pages/agent-panel/ArtifactsPanel.tsx | 无直接专项测试；RMD-05 迁移验收 | RMD-05 |
...
| `web/src/components/file-icon-helper.tsx` | `apps/web/src/components/file-icon-helper.tsx` | apps-web | packages/agent-runtime/web/components/chat/FilePickerPanel.tsx; web/src/components/agent-panel/ChangedFilesSection.tsx; web/src/components/agent-panel/FileTabsBar.tsx; web/src/components/agent-panel/file-tree-view.tsx | web/src/__tests__/file-icon-and-card-registry-pure.test.ts, web/src/__tests__/file-icon-helper-round39.test.ts | RMD-08 |
| `web/src/components/FilePickerDialog.tsx` | `apps/web/src/components/FilePickerDialog.tsx` | apps-web | packages/agent-runtime/web/components/chat/ChatComposer.tsx | web/src/__tests__/file-picker-dialog.test.tsx | RMD-08 |
| `web/src/components/layout/app-header.tsx` | `apps/web/src/components/layout/app-header.tsx` | apps-web | apps/web/src/routes/agent/_panel/workflow.tsx; packages/resources/agent-config/web/pages/agent-panel/pages/agent-sites-catalog.tsx; packages/resources/channel/web/pages/agent-panel/pages/AgentChannelsPage.tsx; packages/resources/identity-admin/web/pages/agent-panel/pages/AgentApiKeysPage.tsx; packages/resources/identity-admin/web/pages/agent-panel/pages/AgentOrganizationsPage.tsx; packages/resources/knowledge/web/pages/agent-panel/pages/AgentKnowledgeBasesPage.tsx; packages/resources/mcp/web/pages/agent-panel/pages/agent-mcp-catalog.tsx; packages/resources/model-management/web/pages/agent-panel/pages/VerticalModelsPage.tsx; packages/resources/model-management/web/pages/agent-panel/pages/agent-models-catalog.tsx; packages/resources/prod-view/web/pages/agent-panel/pages/AgentProdViewsPage.tsx; packages/resources/skill/web/pages/agent-panel/pages/agent-skills-catalog.tsx; packages/resources/task/web/pages/agent-panel/pages/AgentTasksPage.tsx; packages/resources/workflow/web/pages/workflow/WorkflowVersions.tsx; web/src/pages/agent-panel/pages/AgentDashboardPage.tsx; web/src/pages/agent-panel/pages/AgentManagementPage.tsx; web/src/pages/agent-panel/pages/AlgorithmsPage.tsx | 无直接专项测试；RMD-08 迁移验收 | RMD-08 |
...
| `web/src/hooks/use-changed-files-stats.ts` | `apps/web/src/hooks/use-changed-files-stats.ts` | apps-web | web/src/pages/agent-panel/ChatArea.tsx | web/src/__tests__/chat-stats.test.tsx | RMD-08 |
...
| `web/src/hooks/usePageVisible.ts` | `apps/web/src/hooks/usePageVisible.ts` | apps-web | packages/agent-runtime/web/agent-panel/ChatPanel.tsx; web/src/pages/agent-panel/ChatArea.tsx | 无直接专项测试；RMD-08 迁移验收 | RMD-08 |
...
| `web/src/i18n/locales/en/components.json` | `apps/web/src/i18n/locales/en/components.json` | apps-web | apps/web/src/i18n/index.ts | web/src/__tests__/message.ssr.test.tsx | RMD-08 |
...
| `web/src/i18n/locales/zh/components.json` | `apps/web/src/i18n/locales/zh/components.json` | apps-web | apps/web/src/i18n/index.ts | packages/agent-runtime/web/__tests__/chat-empty-state.test.tsx, web/src/__tests__/message.ssr.test.tsx | RMD-08 |
...
| `web/src/lib/agent-resource-access.ts` | `apps/web/src/lib/agent-resource-access.ts` | apps-web | packages/resources/agent-config/web/pages/agent-panel/agent-editor/AgentEditorSections.tsx; packages/resources/agent-config/web/pages/agent-panel/agent-editor/AgentFormDialog.tsx; web/components/ChatInterface.tsx; web/src/pages/agent-panel/AgentSidebarTree.tsx; web/src/pages/agent-panel/pages/AgentManagementPage.tsx | packages/resources/agent-config/web/__tests__/agent-resource-access-flow.test.ts, web/src/__tests__/agent-form-dialog-pure-logic.test.ts | RMD-08 |
...
| `web/src/lib/artifacts-preview-events.ts` | `apps/web/src/lib/artifacts-preview-events.ts` | apps-web | packages/agent-runtime/web/components/chat/MessageBubble.tsx; packages/agent-runtime/web/components/chat/ToolCallRow.tsx; web/src/pages/agent-panel/ArtifactsPanel.tsx; web/src/pages/agent-panel/ChatArea.tsx | web/src/__tests__/artifacts-preview-events.test.ts | RMD-08 |
...
| `web/src/lib/chat-stats.ts` | `apps/web/src/lib/chat-stats.ts` | apps-web | web/components/ChatInterface.tsx; web/src/hooks/use-changed-files-stats.ts | web/src/__tests__/chat-stats.test.tsx | RMD-08 |
...
| `web/src/lib/context-queue.ts` | `apps/web/src/lib/context-queue.ts` | apps-web | packages/agent-runtime/web/components/chat/ChatComposer.tsx; packages/agent-runtime/web/components/chat/ChatQuoteMessage.tsx; packages/agent-runtime/web/components/chat/MessageBubble.tsx; packages/agent-runtime/web/components/chat/composer-assets.tsx; packages/resources/workflow/web/pages/workflow/WorkflowEditor.tsx; web/components/ChatInterface.tsx; web/src/lib/use-context-queue.ts; web/src/lib/use-workflow-events.ts | web/src/__tests__/context-queue.test.ts | RMD-08 |
| `web/src/lib/extract-changed-files.ts` | `apps/web/src/lib/extract-changed-files.ts` | apps-web | packages/agent-runtime/web/components/chat/chat-status-panel.tsx; web/components/ChatInterface.tsx; web/src/components/agent-panel/ChangedFilesSection.tsx; web/src/components/agent-panel/FileTabsBar.tsx; web/src/components/agent-panel/artifacts-files-workspace.tsx; web/src/hooks/use-changed-files-stats.ts; web/src/lib/chat-stats.ts; web/src/pages/agent-panel/ArtifactsPanel.tsx | web/src/__tests__/chat-stats.test.tsx, web/src/__tests__/extract-changed-files-boundaries.test.ts, web/src/__tests__/extract-changed-files.test.ts, web/src/__tests__/tool-semantic.test.ts | RMD-08 |
...
| `web/src/lib/password-crypto.ts` | `apps/web/src/lib/password-crypto.ts` | apps-web | web/components/ChangePasswordDialog.tsx; web/src/pages/LoginPage.tsx | 无直接专项测试；RMD-08 迁移验收 | RMD-08 |
...
| `web/src/lib/structured-to-thread.ts` | `apps/web/src/lib/structured-to-thread.ts` | apps-web | packages/agent-runtime/web/hooks/use-chat-state.ts; packages/agent-runtime/web/hooks/use-session-state.ts; web/components/ChatInterface.tsx | web/src/__tests__/permission-options.test.ts, web/src/__tests__/structured-thread-additional.test.ts, web/src/__tests__/structured-thread-boundaries.test.ts, web/src/__tests__/structured-to-thread.test.ts, web/src/__tests__/todo.test.ts | RMD-08 |
...
| `web/src/pages/admin/AdminSandboxPage.tsx` | `packages/resources/sandbox/web/src/pages/admin/AdminSandboxPage.tsx` | resource-sandbox | apps/web/src/routes/admin/sandbox.tsx | 无直接专项测试；RMD-03 迁移验收 | RMD-03 |
| `web/src/pages/admin/components/MasterKeyGate.tsx` | `packages/resources/sandbox/web/src/pages/admin/components/MasterKeyGate.tsx` | resource-sandbox | packages/resources/model-management/web/pages/admin/AdminModelGatewayPage.tsx; packages/resources/observer/web/pages/admin/AdminLogsPage.tsx; packages/resources/observer/web/pages/admin/AdminObserverPage.tsx; packages/resources/observer/web/pages/admin/AdminPeoplePage.tsx; web/src/pages/admin/AdminSandboxPage.tsx | 无直接专项测试；RMD-03 迁移验收 | RMD-03 |
| `web/src/pages/admin/components/RemoteSandboxPanel.tsx` | `packages/resources/sandbox/web/src/pages/admin/components/RemoteSandboxPanel.tsx` | resource-sandbox | web/src/pages/admin/AdminSandboxPage.tsx | 无直接专项测试；RMD-03 迁移验收 | RMD-03 |
| `web/src/pages/admin/components/SearchableUsageFilter.tsx` | `packages/resources/sandbox/web/src/pages/admin/components/SearchableUsageFilter.tsx` | resource-sandbox | packages/resources/model-management/web/pages/admin/AdminModelGatewayPage.tsx | 无直接专项测试；RMD-03 迁移验收 | RMD-03 |
| `web/src/pages/admin/utils.ts` | `packages/resources/sandbox/web/src/pages/admin/utils.ts` | resource-sandbox | packages/resources/observer/web/pages/admin/AdminObserverPage.tsx; packages/resources/observer/web/pages/admin/components/ObserverFlatTable.tsx; packages/resources/observer/web/pages/admin/components/ObserverIntegrityAlert.tsx; packages/resources/observer/web/pages/admin/components/ObserverMachineTree.tsx; packages/resources/observer/web/pages/admin/components/ObserverOrgTree.tsx | packages/resources/observer/web/__tests__/admin-observer-utils.test.ts | RMD-03 |
...
| `web/src/pages/agent-panel/AgentSidebarConfig.tsx` | `apps/web/src/pages/agent-panel/AgentSidebarConfig.tsx` | apps-web | web/src/pages/agent-panel/AgentSidebar.tsx | web/src/__tests__/agent-sidebar-config-filter-pure.test.ts, web/src/__tests__/agent-sidebar-config.test.ts | RMD-08 |
...
| `web/src/pages/agent-panel/artifacts-workspace.css` | `apps/web/src/pages/agent-panel/artifacts-workspace.css` | apps-web | web/src/pages/agent-panel/ChatArea.tsx | 无直接专项测试；RMD-08 迁移验收 | RMD-08 |
| `web/src/pages/agent-panel/ArtifactsPanel.tsx` | `apps/web/src/pages/agent-panel/ArtifactsPanel.tsx` | apps-web | web/src/pages/agent-panel/AgentAppShell.tsx; web/src/pages/agent-panel/ChatArea.tsx | 无直接专项测试；RMD-08 迁移验收 | RMD-08 |
| `web/src/pages/agent-panel/chat-design-composer.css` | `packages/chat-channel/web/src/pages/agent-panel/chat-design-composer.css` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `web/src/pages/agent-panel/chat-design-messages-tools.css` | `packages/chat-channel/web/src/pages/agent-panel/chat-design-messages-tools.css` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `web/src/pages/agent-panel/chat-design-responsive.css` | `packages/chat-channel/web/src/pages/agent-panel/chat-design-responsive.css` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `web/src/pages/agent-panel/chat-design-selection.css` | `packages/chat-channel/web/src/pages/agent-panel/chat-design-selection.css` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `web/src/pages/agent-panel/chat-design-shell.css` | `packages/chat-channel/web/src/pages/agent-panel/chat-design-shell.css` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `web/src/pages/agent-panel/chat-design-status.css` | `packages/chat-channel/web/src/pages/agent-panel/chat-design-status.css` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `web/src/pages/agent-panel/chat-design.css` | `packages/chat-channel/web/src/pages/agent-panel/chat-design.css` | chat-channel | 无仓内生产 importer；RMD-01 接线时确认 packages/chat-channel 公开入口 | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `web/src/pages/agent-panel/chat-layout.css` | `packages/chat-channel/web/src/pages/agent-panel/chat-layout.css` | chat-channel | web/src/pages/agent-panel/ChatArea.tsx | 无直接专项测试；RMD-01 迁移验收 | RMD-01 |
| `web/src/pages/agent-panel/ChatArea.tsx` | `packages/chat-channel/web/src/pages/agent-panel/ChatArea.tsx` | chat-channel | packages/resources/prod-view/web/pages/prod-view/ProdViewPage.tsx; web/src/pages/agent-panel/AgentPanelLayout.tsx | web/src/__tests__/chat-area-environment-deletion.test.tsx | RMD-01 |
| `web/src/pages/agent-panel/components/ChunkDetailSheet.tsx` | `packages/resources/knowledge/web/src/pages/agent-panel/components/ChunkDetailSheet.tsx` | resource-knowledge | packages/resources/knowledge/web/pages/agent-panel/pages/AgentKnowledgeBasesPage.tsx | 无直接专项测试；RMD-05 迁移验收 | RMD-05 |
| `web/src/pages/agent-panel/components/EmbeddingModelManager.tsx` | `packages/resources/model-management/web/src/pages/agent-panel/components/EmbeddingModelManager.tsx` | model-management | packages/resources/knowledge/web/pages/agent-panel/pages/AgentKnowledgeBasesPage.tsx | 无直接专项测试；RMD-04 迁移验收 | RMD-04 |
...
| `web/src/pages/agent-panel/components/RetrievalTestPanel.tsx` | `packages/resources/knowledge/web/src/pages/agent-panel/components/RetrievalTestPanel.tsx` | resource-knowledge | packages/resources/knowledge/web/pages/agent-panel/pages/AgentKnowledgeBasesPage.tsx | 无直接专项测试；RMD-05 迁移验收 | RMD-05 |
...
| `web/src/pages/agent-panel/pages/AlgorithmDetailDialog.tsx` | `packages/resources/model-management/web/src/pages/agent-panel/pages/AlgorithmDetailDialog.tsx` | model-management | web/src/pages/agent-panel/pages/AlgorithmsPage.tsx | 无直接专项测试；RMD-04 迁移验收 | RMD-04 |
| `web/src/pages/agent-panel/pages/AlgorithmsPage.tsx` | `packages/resources/model-management/web/src/pages/agent-panel/pages/AlgorithmsPage.tsx` | model-management | apps/web/src/routes/agent/_panel/algorithms.tsx; web/src/pages/agent-panel/pages/AlgorithmDetailDialog.tsx | 无直接专项测试；RMD-04 迁移验收 | RMD-04 |
...
| `web/src/types/index.ts` | `apps/web/src/types/index.ts` | apps-web | packages/agent-runtime/web/components/chat/ChatComposer.tsx; packages/agent-runtime/web/components/chat/FilePickerPanel.tsx; packages/agent-runtime/web/components/chat/useDragUpload.ts; web/src/components/FilePickerDialog.tsx; web/src/pages/agent-panel/AgentSidebarTree.tsx | web/src/__tests__/agent-sidebar-instance-order.test.ts, web/src/__tests__/file-picker-dialog.test.tsx | RMD-08 |
