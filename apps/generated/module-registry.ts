...
import { moduleManifest as manifest2 } from "../web/fenix.module.ts";
import type { ModuleManifest } from "@fenix/platform-sdk";

/** 构建期收集的可信模块集合；应用启动时只能从该集合选择模块。 */
export const generatedModuleManifests = [manifest0, manifest1, manifest2] as const satisfies readonly ModuleManifest[];
