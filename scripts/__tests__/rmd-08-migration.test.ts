...
const RMD_08_MOVES = [
  ...
  ["web/src/__tests__/api-client.test.ts", "packages/agent-runtime/web/__tests__/api-client.test.ts"],
  ...
  [
    "web/src/__tests__/folder-upload-batching.test.ts",
    "packages/agent-runtime/web/__tests__/folder-upload-batching.test.ts",
  ],
  ["web/src/__tests__/form-utils.test.ts", "apps/web/src/__tests__/form-utils.test.ts"],
  ["web/src/__tests__/fs-upload-url.test.ts", "packages/agent-runtime/web/__tests__/fs-upload-url.test.ts"],
  ...
  [
    ...
    "packages/agent-runtime/web/__tests__/peri-task-details-api.test.ts",
  ],
  ...
  ["web/src/__tests__/use-task-views.test.tsx", "packages/agent-runtime/web/__tests__/use-task-views.test.tsx"],
  ["web/src/__tests__/utils.test.ts", "apps/web/src/__tests__/utils.test.ts"],
  ["web/src/api/fs.ts", "packages/agent-runtime/web/api/fs.ts"],
  ["web/src/api/instances.ts", "apps/web/src/api/instances.ts"],
  ["web/src/api/peri-task-details.ts", "packages/agent-runtime/web/api/peri-task-details.ts"],
  ["web/src/api/registry.ts", "packages/resources/machine/web/api/registry.ts"],
  ...
  ["web/src/hooks/use-task-views.ts", "packages/agent-runtime/web/hooks/use-task-views.ts"],
  ["web/src/hooks/useMetaAgent.ts", "packages/resources/agent-config/web/hooks/use-meta-agent.ts"],
  ...
  ["web/src/lib/admin-key.ts", "packages/resources/identity-admin/web/lib/admin-key.ts"],
  ["web/src/lib/agent-node.ts", "packages/resources/agent-config/web/lib/agent-node.ts"],
  ["web/src/lib/agent-resource-access.ts", "packages/resources/agent-config/web/lib/agent-resource-access.ts"],
  ["web/src/lib/agent-utils.ts", "packages/resources/agent-config/web/lib/agent-utils.ts"],
  ...
  ["web/src/lib/context-queue.ts", "packages/web-runtime/web/chat/context-queue.ts"],
  ...
  ["web/src/lib/password-crypto.ts", "packages/resources/identity-admin/web/lib/password-crypto.ts"],
  ...
  ["web/src/lib/use-context-queue.ts", "packages/web-runtime/web/chat/use-context-queue.ts"],
  ["web/src/lib/use-workflow-events.ts", "packages/resources/workflow/web/lib/use-workflow-events.ts"],
  ...
  [
    "web/src/pages/agent-panel/AgentSidebarConfig.tsx",
    "packages/resources/agent-config/web/pages/agent-panel/AgentSidebarConfig.tsx",
  ],
  ...
  [
    ...
    "packages/resources/knowledge/web/pages/agent-panel/KnowledgeGraphPanel.tsx",
  ],
  [
  ...
  ["web/src/types/config.ts", "packages/resources/agent-config/web/types/config.ts"],
  ...
  ["web/src/types/index.ts", "packages/agent-runtime/web/types/index.ts"],
